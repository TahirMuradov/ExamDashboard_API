        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PupilCode = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExamPupils", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExamPupils_Exams_ExamId",
                        column: x => x.ExamId,
                        principalTable: "Exams",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExamPupils_Pupils_PupilId",
                        column: x => x.PupilId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamPupils_ExamId",
                table: "ExamPupils",
                column: "ExamId");

            migrationBuilder.CreateIndex(
                name: "IX_ExamPupils_PupilId",
                table: "ExamPupils",
                column: "PupilId");
